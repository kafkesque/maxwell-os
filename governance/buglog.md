...
- **Status:** ✅ FIXED (prompt-level) — verify `elaboration == ""` on non-principle records at next S2 run (BUG-165 rerun).
...
- **Status:** 🟡 OPEN — fix applied at the prompt; verify on the full 143-record TI corpus during BUG-165 rerun.
