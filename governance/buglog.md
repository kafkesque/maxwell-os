...
## 🟠 BUG-198 — 2026-09-01 — 6 S2 singleton principles emitted `application: 'None'` and were DROPPED at S4 (recoverable extraction gap) — OPEN (recover, then fix S2)
...
## 🟠 BUG-196 — 2026-09-01 — FB name truncation at `FB_NAME_MAX_WORDS=8` cuts mid-word — OPEN (future S4 fix)
...
## 🟠 BUG-197 — 2026-09-01 — gpt-oss classifier emits DOMAIN labels as DISCIPLINE (domain-not-discipline) — POST-HOC remap + future S4 prompt fix
...
## 🟠 BUG-193 — 2026-08-31 — `CircuitOpenError` undefined in `discover_principles` (stage2_extract.py:1736) — OPEN (S2 path, deferred)
