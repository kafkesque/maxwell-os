...
> **Updated:** 2026-09-02 | **Decisions:** D2000-D2509
...
| 31 | P1 | **BUG-205**: S1/S2 book-level dedup — collapse near-duplicate book files (author+title NFKC + download-source strip) before `source_diversity` | `book_metadata.py` | ✅ DONE (D2507 — `_unicode_fold` + `_SPACE_SUBTITLE_SPLIT` + fallback sanitize; 962→910 source_ids; residual title-rename/co-author/truncation → post-S6 Stage 0.5) |
